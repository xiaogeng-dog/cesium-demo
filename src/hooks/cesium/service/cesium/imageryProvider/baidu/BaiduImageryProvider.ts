...
class BaiduImageryProvider {
  ...
  requestImage(x: number, y: number, level: number) {
    ...
    const xTiles: any = this._tilingScheme.getNumberOfXTilesAtLevel(level)
    const yTiles: any = this._tilingScheme.getNumberOfYTilesAtLevel(level)
